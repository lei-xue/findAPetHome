      ...
      rounded-lg">
        ...
        <div className="w-1/2 flex items-center justify-center">
          <div className="max-w-md w-full p-6">
            ...
            <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl mb-12"><span className="text-transparent bg-clip-text bg-gradient-to-r to-pink-600 from-gray-700">Register Here</span></h1>
